...
from forms import *
from models import db, app, moment, Venue, Show, Artist
#----------------------------------------------------------------------------#
# App Config.
#----------------------------------------------------------------------------#
...
def artists():
  ...
  '''
  data = Artist.query.with_entities(Artist.id, Artist.name).order_by(Artist.id).all()
...
def shows():
  ...
  '''
  data = Show.query.order_by(Show.id).all()
